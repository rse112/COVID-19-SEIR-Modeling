...
% Initial values
S(1) = 50000000; Sf(1) = 0; E(1) = 516; I(1) = 126; Q(1) = 2; R(1) = 0; N(1) = S(1)+Sf(1)+E(1)+I(1)+Q(1)+R(1);    
...
set(gcf,'color','w');
hold on
plot(ttemp,data,'ro','markersize',5,'linewidth',1.7)
plot(tray,alpha*I,'k','linewidth',2)
...
% set(gcf,'color','w');
% hold on
% plot(ttemp,B,'ro','markersize',5,'linewidth',1.7)
% plot(tray,cumsum(alpha*I*dt),'k','linewidth',2) % 누적 모델 추가
